...
public abstract class AbstractBlocklyActivity extends AppCompatActivity {
    ...
    public void onLoadWorkspaceFile(String fileName) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton clear = findViewById(R.id.blockly_clear);
        ...
        ImageButton run = findViewById(R.id.blockly_run_code);
        ...
        ImageButton save = findViewById(R.id.blockly_save);
        ...
        ImageButton load = findViewById(R.id.blockly_load);
