...
game.CoinEntity = me.CollectableEntity.extend({
    ...
    onCollision : function (response, other) {
        ...
        // if(pickUp == true){
        //     // make sure you can't pick the coin up again
        //     this.body.setCollisionMask(me.collision.types.NO_OBJECT);
        //
        //     // remove it
...
// game.VolumeEntity = me.Entity.extend({
//     init:function (x, y, settings) {
...
//         me.game.world.removeChild(this);
//
//         game.CoinEntity.body.setCollisionMask(me.collision.types.COLLECTABLE_OBJECT)
//         return false
//     }
//
// })
...
game.PlayerEntity = me.Entity.extend({
    ...
    update: function (dt) {
        ...
        if (actionNum == 0 && actionList.length == 0 && started && game.data.score != 2){
            game.data.score = 0;
            game.data.bump = 0;
            started = false;
            game.onload();
